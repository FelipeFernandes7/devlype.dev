    ...
    <section className="w-full items-center justify-center flex flex-col gap-4">
      ...
      <div className="w-full flex items-center justify-center flex-col">
        ...
        <span className="w-full flex items-center text-center mt-4 font-normal text-lg max-w-5xl">
          ...
          but I also have extensive knowledge of the back-end. I am looking for
          an opportunity that allows me to face challenges and continue to
          evolve with the company. I am ambitious and want to advance in my
          professional career. I have a passion for programming and look forward
          to contributing significantly to the team's success.
        </span>
      </div>
